...
class Camera:
    def __init__(self, lookfrom: Q_Vector3d, lookat: Q_Vector3d, vup: Q_Vector3d, vfov: float, aspect_ratio: float, aperture: float = 0.4, focus_dist: float = 1.0):
        theta = vfov * pi / 180.0
        ...
        self.focus_dist = (lookfrom - lookat).length  # self.focus_dist
    ...
    def get_ray_from_camera(self, x: float, y: float) -> Ray:
        rd = Q_Vector3d(0, 0, 0)  # self.lens_radius * Q_Vector3d.random_in_unit_disk()
