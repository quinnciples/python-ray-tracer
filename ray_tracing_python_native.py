...
objects = [
    ...
    SpherePrimitive(position=Q_Vector3d(x=16, y=12, z=50), ambient=Q_Vector3d(0.1, 0.1, 0), diffuse=Q_Vector3d(0.7, 0.7, 0), specular=Q_Vector3d(1.0, 1.0, 1.0), shininess=100, reflection=0.75, radius=8.0),  # Yellow
    SpherePrimitive(position=Q_Vector3d(x=-10, y=12, z=40), ambient=Q_Vector3d(0.1, 0.1, 0.1), diffuse=Q_Vector3d(0.7, 0.7, 0.7), specular=Q_Vector3d(1.0, 1.0, 1.0), shininess=100, reflection=0.75, radius=8.0),  # White

    # Bottom plane - plane
    PlanePrimitive(front_bottom_left=Q_Vector3d(x=-500, y=-15, z=-10), rear_top_right=Q_Vector3d(500, -15, 200), ambient=Q_Vector3d(0.1, 0.1, 0.1), diffuse=Q_Vector3d(0.1, 0.1, 0.1), specular=Q_Vector3d(0.3, 0.3, 0.3), shininess=0, reflection=0),
